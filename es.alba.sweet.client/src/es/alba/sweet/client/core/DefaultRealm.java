package es.alba.sweet.client.core;

import org.eclipse.core.databinding.observable.Realm;

/**
 * Simple realm implementation that will set itself as default when constructed. Invoke {@link #dispose()} to remove the realm from being the default. Does not support
 * asyncExec(...).
 */
